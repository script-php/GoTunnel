...
- [ ] Register streams before STREAM_OPEN; enforce stream limits atomically.
...
- [ ] Make shutdown idempotent; stop HTTP, flush logger, and wait for workers.
...
- [ ] Make tunnel changes transactional and reject duplicate remote-port ownership.
- [x] Validate loaded configuration, initialize missing maps, and return deep copies.
- [ ] Roll back failed persistence and improve configuration file durability/permissions.
...
## Operations
- [ ] Add CI for tests, race detection, vet, and builds.
